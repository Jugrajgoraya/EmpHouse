    ...
    <div className='home-bg-image'>
        ...
        <form className='position-absolute top-50 start-50 translate-middle fw-bolder' onSubmit={createShift}>
            <div className='m-1 row'>
                <label className='col-8 fs-4 bg-white m-1 shadow rounded' htmlFor="date" >Date</label>
                <input className='col btn btn-light m-1' type="date" name="date" onChange={(event)=>{setDate(event.target.value)}}/>
            </div>
            <div className='m-1 row'>
                <label className='col-8 fs-4 bg-white m-1 shadow rounded' htmlFor="shift_type">Shift Type</label>
            ...
            <div className='m-1 row'>
                <label className='col-8 fs-4 bg-white m-1 shadow rounded' htmlFor="location">Location</label>
